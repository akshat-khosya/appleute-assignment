...
const LoginForm = () => {
    ...
    const { axiosInstance, setAuthenticates } = useContext(GlobalContext);
            ...
            <form action="" onSubmit={handleSubmit}>
                ...
                <div className="my-4">
                    ...
                    <div className="submit text-center my-4">
                        <button type="submit" className="w-100 border-0 fd-btn">{loading ? <CircularProgress /> : "LOG IN"}</button>
                    </div>
                    <div className="bt text-center">
                        <div className="signup mt-2"><span>{`Don't have an account ?`}</span><Link to="/signup" className="fd-color-primary">Sign Up</Link></div>
                    </div>
                </div>
            </form>
        </div>
